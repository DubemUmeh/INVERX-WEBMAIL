...
export default function InboxRulesSettingsPage() {
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-neutral-500 text-base">
          Automate your inbox with filters and actions.
        </p>
      </div>
      <div className="rounded-xl border border-dashed border-neutral-300 dark:border-neutral-700 p-12 flex flex-col items-center justify-center text-center">
         ...
         <h3 className="text-lg font-medium text-neutral-900 dark:text-neutral-100">No rules configured</h3>
         <p className="text-neutral-500 max-w-sm mt-1">Set up rules to automatically organize incoming messages.</p>
      </div>
    </div>
  );
}
