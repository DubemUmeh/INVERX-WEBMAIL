  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-dashed border-neutral-300 dark:border-neutral-700 p-12 flex flex-col items-center justify-center text-center">
         ...
         <h3 className="text-lg font-medium text-neutral-900 dark:text-neutral-100">Default settings active</h3>
         <p className="text-neutral-500 max-w-sm mt-1">You are currently using the default notification preferences.</p>
      </div>
    </div>
  );
}
