          ...
          {!showAddForm && (
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  <span>
                    <Button
                      ...
                      disabled={!isVerified}
                      className="bg-primary hover:bg-primary/90 text-accent disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                ...
                {!isVerified && (
                  <TooltipContent>
                    <p>Verification required to add SMTP configurations</p>
                  </TooltipContent>
                )}
              </Tooltip>
            </TooltipProvider>
            ...
            {smtpConfigs.length === 0 && !showAddForm && (
              <div className="text-center py-12">
                ...
                <Button
                  ...
                  disabled={!isVerified}
                  className="bg-primary hover:bg-primary/90 text-accent disabled:opacity-50"
                >
                  <Plus size={16} className="mr-2" />
                  Add Your First SMTP
                </Button>
                {!isVerified && (
                  <p className="text-amber-500 text-xs mt-4 flex items-center justify-center gap-1">
